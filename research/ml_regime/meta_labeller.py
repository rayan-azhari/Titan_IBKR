...
Fixes the hardcoded threshold problem.

Hardcoding 0.6 is overfitting-by-hand. The threshold must be:
...
Also exposes predict_proba() for continuous position sizing.
"""
...
from research.ml_regime.cross_validation import PurgedKFold, compute_sample_uniqueness
...
class MetaLabeller:
    ...
    def fit(
        ...
        Args:
            ...
            bar_times:   Full price bar DatetimeIndex for sample uniqueness weights.
        """
        ...
        for _, (train_idx, test_idx) in enumerate(cv.split(X, y, exit_times)):
