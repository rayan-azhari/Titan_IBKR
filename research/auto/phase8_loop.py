...
experiments = [
    ...
    ("MR AUD_JPY v46 sp0.5 oos9k", c(MR_V46, spread_bps=0.5, slippage_bps=0.2, oos_bars=9000)),
    ("MR AUD_JPY v46 sp0.5 oos6k", c(MR_V46, spread_bps=0.5, slippage_bps=0.2, oos_bars=6000)),
    # ── 5. Best vwap from Phase 7 suite + cost tightening ─────────────────────
    ("MR AUD_JPY v44 don sp0.5", c(MR_V46, vwap_anchor=44, spread_bps=0.5, slippage_bps=0.2)),
    ("MR AUD_JPY v42 don sp0.5", c(MR_V46, vwap_anchor=42, spread_bps=0.5, slippage_bps=0.2)),
    ...
    (
        "MR AUD_USD v46 don sp0.5",
        c(MR_V46, instruments=["AUD_USD"], spread_bps=0.5, slippage_bps=0.2),
    ),
