...
XA_LEAD = dict(
    strategy="cross_asset", instruments=["QQQ"], bond="LQD",
    lookback=10, hold_days=10, threshold=0.50,
    is_days=504, oos_days=126, spread_bps=5.0,
)
...
experiments = [
    ...
    ("MR AUD_JPY spread0.5", c(MR_BASE, instruments=["AUD_JPY"],
                               spread_bps=0.5, slippage_bps=0.2)),
    ("MR AUD_JPY spread0", c(MR_BASE, instruments=["AUD_JPY"],
                             spread_bps=0.0, slippage_bps=0.0)),
    ("MR AUD_JPY spread1.5", c(MR_BASE, instruments=["AUD_JPY"],
                               spread_bps=1.5, slippage_bps=0.5)),
    ...
    ("MR AUD_JPY sp1 donchian", c(MR_LEAD, instruments=["AUD_JPY"],
                                  regime_filter="conf_donchian_pos_20")),
    ("MR AUD_JPY sp1 no_filter", c(MR_LEAD, instruments=["AUD_JPY"],
                                   regime_filter="no_filter")),
    ...
    ("TQQQ cbars=6", c(ML_BASE, instruments=["TQQQ"],
                       label_params=[
    ...
    ("TQQQ cbars=4", c(ML_BASE, instruments=["TQQQ"],
                       label_params=[
    ...
    ("TF SPY SMA200 cost1", c(dict(
        strategy="trend_following", timeframe="D",
        slow_ma=200, ma_type="SMA", cost_bps=1.0,
        is_days=504, oos_days=126), instruments=["SPY"])),
    ("TF GLD SMA200 cost2", c(dict(
        strategy="trend_following", timeframe="D",
        slow_ma=200, ma_type="SMA", cost_bps=2.0,
        is_days=504, oos_days=126), instruments=["GLD"])),

    # ── 10. IWB with MUCH wider RSI bands (radical change) ───────────────────
    ("IWB rsi40/60", c(ML_BASE, instruments=["IWB"],
                       label_params=[
    ...
    ("IWB rsi35/65", c(ML_BASE, instruments=["IWB"],
                       label_params=[
