...
MR_V40 = dict(
    ...
    vwap_anchor=40, regime_filter="conf_donchian_pos_20",
...
experiments = [
    ...
    ("MR AUD_JPY v40 don oos9k sp0.5", c(MR_V40, oos_bars=9000,
    ...
    ("MR AUD_USD v36 don sp0.5", c(MR_STAR, instruments=["AUD_USD"],
                                   spread_bps=0.5, slippage_bps=0.2)),
    ...
    ("AUD_JPY stacking D cbars3", c(ML_BASE, instruments=["AUD_JPY"],
                                    label_params=[
