...
def main() -> None:
    ...
    print(f"  turtle CAT: {len(turtle_cat)} bars, {turtle_cat.index[0].date()} -> {turtle_cat.index[-1].date()}")
    ...
    print("\n[GEM J5]"); print(kelly_gem.report())
    print("\n[turtle CAT]"); print(kelly_turtle.report())
    ...
    for gem_w, turt_w in [(0.70, 0.20), (0.65, 0.20), (0.70, 0.15), (0.50, 0.30)]:
        ...
        print(f"{gem_w:>6.0%} {turt_w:>7.0%} {res.p_kill_trip:>7.2%} {res.p95_maxdd_at_size:>+8.2%} {str(res.passes()):>8}")
