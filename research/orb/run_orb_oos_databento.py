...
if not API_KEY:
    ...
    print(
        "Databento is required to fetch 1-Year of 5-minute historical data for Out-of-Sample testing."
    )
...
if __name__ == "__main__":
    ...
    if results:
        ...
        print("================================================================================")
        print(
            f"{'Ticker':<8} | {'IS Return':<12} | {'IS Win %':<10} ||| {'OOS Return':<12} | {'OOS Win %':<10}"
        )
        print("-" * 80)
        ...
        for r in results:
            ...
            print(
                f"{r['ticker']:<8} | {is_ret:<12} | {is_win:<10} ||| {oos_ret:<12} | {oos_win:<10} [{drift}]"
            )
        print("================================================================================")
