"""run_param_sweep.py -- Indicator Parameter IC Sweep.
...
Usage:
    uv run python research/ic_analysis/run_param_sweep.py
    uv run python research/ic_analysis/run_param_sweep.py \\
...
from research.ic_analysis.run_signal_sweep import _load_ohlcv  # noqa: E402
...
def _print_summary(all_results: pd.DataFrame) -> None:
    """Print best parameter per family × horizon."""
    W = 80
    print("\n" + "=" * W)
...
def run_param_sweep(
    ...
    full_path = report_dir / f"param_sweep_{slug}.csv"
    ...
    best_path = report_dir / f"param_best_{slug}.csv"
