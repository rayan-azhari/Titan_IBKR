...
| ml | EUR/USD H1 XGB meta-classifier (single-pair) | ML_CLASSIFIER | TBM (López de Prado) + multi-feature TA | (rebuilt) | ✅ DONE 2026-05-17 (FINAL **RETIRE**). Exhaustive cascade: (1) single-pair 24h sanc AUC 0.488 RETIRE; (2) L61 multi-asset grid found 6/16 sanc AUC > 0.55 = MARGINAL_BY_ASSET; (3) **per-asset 5-axis on top-6 = 0/6 deployment-eligible** (all CI_lo < 0, 96-99% active = degenerate trading, costs dominate). L71 + L72 added. **AUC ≠ Sharpe** confirmed empirically. |
