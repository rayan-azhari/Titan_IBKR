...
| ml | EUR/USD H1 XGB meta-classifier (single-pair) | ML_CLASSIFIER | TBM (López de Prado) + multi-feature TA | (rebuilt) | ⚠️ REVISED 2026-05-17 (Wave C). Single-pair / 24h: RETIRE (sanctuary AUC 0.488). **Multi-asset L61 grid (16 assets × 3 horizons × 3 models)**: best cell **6h XGB pooled** has 6/16 sanctuary AUC > 0.55 (IEF 0.589, EUR_GBP 0.588, EUR_USD 0.567, GLD 0.563, USD_CHF 0.562, EUR_CHF 0.562). **MARGINAL_BY_ASSET**, not closed. Next: per-asset 5-axis on top-6. L71 added. |
